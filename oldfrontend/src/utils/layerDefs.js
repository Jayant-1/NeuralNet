...
export const LAYER_CATEGORIES = [
  {
    ...
    items: [
      ...
      { type: 'output', label: 'Output', desc: 'Model output', iconName: 'ArrowUpFromLine', color: '#10b981', bgColor: 'rgba(16, 185, 129, 0.1)', borderColor: 'rgba(16, 185, 129, 0.3)', defaultParams: { units: 10, activation: 'softmax' } },
    ],
  },
  {
    section: 'Core Layers',
...
export const LAYER_PARAMS = {
  ...
  output: [
    ...
    { key: 'activation', label: 'Activation', type: 'select', options: ['softmax', 'sigmoid', 'linear', 'relu', 'tanh'] },
  ],
  dense: [
    { key: 'units', label: 'Units', type: 'number', min: 1 },
